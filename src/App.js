        ...
        <Container className={styles.Main}>
          <Switch>
            ...
            <Route
              ...
              render={() => (
                <MyCommentsList message="No comments found. Adjust the search keyword or comment on a post." />
              )}
            />
            ...
            <Route
              exact
              path="/dailyroutines/create"
              component={DailyRoutineCreateForm}
            />
            <Route exact path="/dailyroutines" component={MyDailyRoutineList} />
            <Route
              exact
              path="/dailyroutines/:id/edit"
              component={DailyRoutineEditForm}
            />
